...
CSRF_TRUSTED_ORIGINS = ['http://localhost:3000','https://mychessapplication.herokuapp.com']
CORS_ORIGIN_WHITELIST = ['http://localhost:3000','https://mychessapplication.herokuapp.com']
